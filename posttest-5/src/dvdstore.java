...
public final class dvdstore {

    private static final ArrayList<dvd_film> dvds = new ArrayList<>();
    private static final ArrayList<duration> drt = new ArrayList<>();
    private static final ArrayList<actor> act = new ArrayList<>();
    private static final ArrayList<rating> rtg = new ArrayList<>();    
